...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference("Reaction.count") do
      post reactions_url, params: { reaction: { class: @reaction.class, service: @reaction.service, widget_id: @reaction.widget_id } }, as: :json
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { class: @reaction.class, service: @reaction.service, widget_id: @reaction.widget_id } }, as: :json
    assert_response :success
  end
