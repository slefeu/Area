...
class ActionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create action" do
    assert_difference("Action.count") do
      post actions_url, params: { action: { class: @action.class, service: @action.service, widget_id: @action.widget_id } }, as: :json
    end
  ...
  test "should update action" do
    patch action_url(@action), params: { action: { class: @action.class, service: @action.service, widget_id: @action.widget_id } }, as: :json
    assert_response :success
  end
